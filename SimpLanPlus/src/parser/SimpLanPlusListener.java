...
public interface SimpLanPlusListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code deleteStat}
	 * labeled alternative in {@link SimpLanPlusParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterDeleteStat(SimpLanPlusParser.DeleteStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code deleteStat}
	 * labeled alternative in {@link SimpLanPlusParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitDeleteStat(SimpLanPlusParser.DeleteStatContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SimpLanPlusParser#funType}.
	 * @param ctx the parse tree
	 */
	void enterFunType(SimpLanPlusParser.FunTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpLanPlusParser#funType}.
	 * @param ctx the parse tree
	 */
	void exitFunType(SimpLanPlusParser.FunTypeContext ctx);
	/**
